...
func (m *DispatchLookupResources3Request) CloneVT() *DispatchLookupResources3Request {
	if m == nil {
		return (*DispatchLookupResources3Request)(nil)
	}
	r := new(DispatchLookupResources3Request)
	r.Metadata = m.Metadata.CloneVT()
	r.Context = (*structpb.Struct)((*structpb1.Struct)(m.Context).CloneVT())
	r.OptionalLimit = m.OptionalLimit
	r.EnableDebugTrace = m.EnableDebugTrace
	...
	if rhs := m.OptionalCursor; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.OptionalCursor = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *DispatchLookupResources3Response) CloneVT() *DispatchLookupResources3Response {
	if m == nil {
...
func (m *LR3Item) CloneVT() *LR3Item {
	...
	if rhs := m.AfterResponseCursorSections; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.AfterResponseCursorSections = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *LookupDebugInfo) CloneVT() *LookupDebugInfo {
	if m == nil {
		return (*LookupDebugInfo)(nil)
	}
	r := new(LookupDebugInfo)
	if rhs := m.CycleMembers; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.CycleMembers = tmpContainer
	}
	if rhs := m.CycleCandidates; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.CycleCandidates = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *LookupDebugInfo) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *DispatchLookupResources3Request) EqualVT(that *DispatchLookupResources3Request) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if len(this.OptionalCursor) != len(that.OptionalCursor) {
		return false
	}
	for i, vx := range this.OptionalCursor {
		vy := that.OptionalCursor[i]
		if vx != vy {
			return false
		}
	}
...
func (this *DispatchLookupResources3Request) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*DispatchLookupResources3Request)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *DispatchLookupResources3Response) EqualVT(that *DispatchLookupResources3Response) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *DispatchLookupResources3Response) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*DispatchLookupResources3Response)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *LR3Item) EqualVT(that *LR3Item) bool {
	...
	if len(this.AfterResponseCursorSections) != len(that.AfterResponseCursorSections) {
		return false
	}
	for i, vx := range this.AfterResponseCursorSections {
		vy := that.AfterResponseCursorSections[i]
		if vx != vy {
			return false
		}
	}
...
func (this *LookupDebugInfo) EqualVT(that *LookupDebugInfo) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	}
	if len(this.CycleMembers) != len(that.CycleMembers) {
		return false
	}
	for i, vx := range this.CycleMembers {
		vy := that.CycleMembers[i]
		if vx != vy {
			return false
		}
	}
	if len(this.CycleCandidates) != len(that.CycleCandidates) {
		return false
	}
	for i, vx := range this.CycleCandidates {
		vy := that.CycleCandidates[i]
		if vx != vy {
			return false
		}
	}
...
func (this *LookupDebugInfo) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*LookupDebugInfo)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *DispatchLookupResources3Request) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.OptionalCursor) > 0 {
		for iNdEx := len(m.OptionalCursor) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.OptionalCursor[iNdEx])
			copy(dAtA[i:], m.OptionalCursor[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.OptionalCursor[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
...
func (m *LR3Item) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.AfterResponseCursorSections) > 0 {
		for iNdEx := len(m.AfterResponseCursorSections) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AfterResponseCursorSections[iNdEx])
			copy(dAtA[i:], m.AfterResponseCursorSections[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AfterResponseCursorSections[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *LookupDebugInfo) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *LookupDebugInfo) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LookupDebugInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.CycleCandidates) > 0 {
		for iNdEx := len(m.CycleCandidates) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CycleCandidates[iNdEx])
			copy(dAtA[i:], m.CycleCandidates[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CycleCandidates[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.CycleMembers) > 0 {
		for iNdEx := len(m.CycleMembers) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CycleMembers[iNdEx])
			copy(dAtA[i:], m.CycleMembers[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CycleMembers[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *DispatchLookupResources3Request) SizeVT() (n int) {
	...
	if len(m.OptionalCursor) > 0 {
		for _, s := range m.OptionalCursor {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *LR3Item) SizeVT() (n int) {
	...
	if len(m.AfterResponseCursorSections) > 0 {
		for _, s := range m.AfterResponseCursorSections {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *LookupDebugInfo) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.CycleMembers) > 0 {
		for _, s := range m.CycleMembers {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
	if len(m.CycleCandidates) > 0 {
		for _, s := range m.CycleCandidates {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *DispatchLookupResources3Request) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DispatchLookupResources3Request: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DispatchLookupResources3Request: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 7:
			...
			m.OptionalCursor = append(m.OptionalCursor, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OptionalLimit", wireType)
...
func (m *DispatchLookupResources3Response) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DispatchLookupResources3Response: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DispatchLookupResources3Response: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LR3Item) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LR3Item: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LR3Item: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AfterResponseCursorSections", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AfterResponseCursorSections = append(m.AfterResponseCursorSections, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *LookupDebugInfo) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LookupDebugInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LookupDebugInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CycleMembers", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CycleMembers = append(m.CycleMembers, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CycleCandidates", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CycleCandidates = append(m.CycleCandidates, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
